...
int main() {
  ...
  /*pchar2[3] = 0; // r(pixel1)
  pchar2[7] = 0 ;//  r(pixel2)
  pchar2[11] = 0; // r(pixel3)
  pchar2[15] = 0; // r(pixel4)
  pchar2[19] = 0; // r(pixel5)
  pchar2[23] = 0; // r(pixel6)
  pchar2[27] = 0; // r(pixel7)
  pchar2[31] = 0; // r(pixel8)
  pchar2[35] = 0; // r(pixel9)
  pchar2[39] = 0; // r(pixel10)*/
 // pchar2[43] = 0; // r(pixel11)
 // pchar2[47] = 0; // r(pixel12)
 // pchar2[51] = 0;// r(pixel13)
//pchar2[55] = 0;// r(pixel14)
 // pchar2[59] = 0;// r(pixel15)
 // pchar2[63] = 0;// r(pixel16)
  //pchar2[67] = 0;// r(pixel17)
 ...
 /*for (int i = 1 ; i <= 401; i = i + 4) {
   ...
   for (int i = 0 ; i <= 400; i = i + 4) {
      unsigned char cinza;
   int media = ((pchar3[i + 1] + pchar3[i + 2] + pchar3[i + 3]) / 3.0);
    pchar3[i + 1]=media;
    pchar3[i + 2]=media;
    pchar3[i + 3]=media;
